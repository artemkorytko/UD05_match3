...
public class GameMonoInstaller : MonoInstaller
{
    ...
    {
        Container.Bind<ISaveSystem>().To<SaveSystemJson>();
    ...
    private void BindBoard()
    {
        ...
        Container.BindFactory<ElementConfigItem, ElementPosition, Element, Element.Factory>().FromComponentInNewPrefab(elementPrefab); // билд фабрики Element.Factory
    ...
    {
        Container.BindInterfacesAndSelfTo<GameManager>().AsSingle().NonLazy();// AsSingle - объект только может быть один!  NonLazy - тип отключить Ленивую ссылку (объект создан сразу)
    }
